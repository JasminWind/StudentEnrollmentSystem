...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <?php
		...
		{
			echo '<li><a href="table2.php" ><span class="glyphicon glyphicon-user"></span> Students</a></li>';
			echo '<li><a href="table3.php"><span class="glyphicon glyphicon-pencil"></span>Courses</a></li>';
            echo '<li><a href="table5.php" ><span class="glyphicon glyphicon-user"></span> Enrollments</a></li>';
