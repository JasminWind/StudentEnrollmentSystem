...
<?php require 'masteradmin.php';?>
    ...
    <button class="btn btn-info"><a href="table5.php">View Enrollments</a> </button>
    </div>
    <table class="table">
  <thead>
    <tr>
...
if($executeQueryresult){
    while ($row=mysqli_fetch_assoc($executeQueryresult)){
        ...
        <td>'.$courseID.'</td>
        <td>
            <button class=><a href="updateclass.php?eml='.$semester.'">Update</a></button>
            <button><a href="delete4.php?eml='.$semester.'">Delete</a></button>
        </td>    
       </tr>';
    }
}
