...
<?php require 'master.php';?>
    ...
    <button class="btn btn-info"><a href="course.php">Add Course</a> </button>
    <button class="btn btn-info"><a href="registration.php">View Courses</a> </button>
    </div>
...
<div class="form-group">
    <label for="courseunit">Teacher  </label>
