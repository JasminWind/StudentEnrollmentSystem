...
<html lang="en">
<head>
	<title> Update students Password</title>
	<meta charset="uft-8">
...
if(isset($_POST['update']))
{
  ...
  $result = mysqli_query($conn, "select students.password from students WHERE id = $id");
     $students = mysqli_fetch_assoc($result);
          if($old == $students['password']){
            $sql = "UPDATE `students` SET `password`='$new' WHERE id = $id";
...
<html>
<head>
  <title>Change Password | students Management System</title>
<body>
  <center>
  ...
  <div class="divider"></div>
    ...
    <!-- <form id = "registration" action="edit.php" method="POST"> -->
                    ...
                    <form id = "registration" action="changepassstudent.php" method="POST">
